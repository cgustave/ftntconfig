...
while True:
    ...
    # fgt.firewall.policy(action='update', id='605', traffic_shaper='CGU-UNUSED-1', traffic_shaper_reverse='CGU-UNUSED-1')
    #fgt.firewall.policy(action='update', id='606', traffic_shaper='CGU-UNUSED-2', traffic_shaper_reverse='CGU-UNUSED-2')
    # my test traffic policy below
    #fgt.firewall.policy(action='update', id='529', traffic_shaper='CGU-TEST-SHAPER')
    #fgt.firewall.policy(action='update', id='529', traffic_shaper_reverse='CGU-TEST-SHAPER')

    #fgt.firewall.policy(action='update', id='190', traffic_shaper='CGU-TEST-SHAPER', traffic_shaper_reverse='CGU-TEST-SHAPER')
    #fgt.firewall.policy(action='update', id='530', traffic_shaper='CGU-UNUSED-3', traffic_shaper_reverse='CGU-UNUSED-3')
    ...
    #fgt.firewall.shaper(action='update', type='shared', name='CGU-UNUSED-3', maximum_bandwidth='1000001', per_policy='disable')
    #fgt.firewall.shaper(action='update', type='shared', name='CGU-UNUSED-3', maximum_bandwidth='1000002', per_policy='enable')


    #fgt.firewall.policy(action='update', id='370', traffic_shaper='CGU-TEST-SHAPER', traffic_shaper_reverse='CGU-TEST-SHAPER')
    ...
    #fgt.firewall.policy(action='update', id='530', traffic_shaper='unset', traffic_shaper_reverse='unset')


    for shp in ['CGU-UNUSED-3', 'CGU-UNUSED-1', 'CGU-UNUSED-2' ]:
